...
readonly HELM_VERSION="${HELM_VERSION:-4.3.0}"
...
readonly DNSCONTROL_VERSION="${DNSCONTROL_VERSION:-5.0.4}"
...
readonly ANSIBLE_CORE_VERSION="${ANSIBLE_CORE_VERSION:-2.21.4}"
# renovate: datasource=pypi depName=ansible-lint
readonly ANSIBLE_LINT_VERSION="${ANSIBLE_LINT_VERSION:-26.8.0}"
# renovate: datasource=github-tags depName=aws/aws-cli
readonly AWS_CLI_VERSION="${AWS_CLI_VERSION:-2.36.43}"
